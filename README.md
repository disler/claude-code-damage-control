...
| Runtime | File Extension | Requirements                                                    |
| ------- | -------------- | --------------------------------------------------------------- |
| Python  | `.py`          | [UV](https://docs.astral.sh/uv/getting-started/installation/)   |
| Bun     | `.ts`          | [Bun](https://bun.sh/docs/installation) + yaml (`bun add yaml`) |
...
| ------------------- | -------------------------------------- | ------- |
| Destructive deletes | `rm -rf`, `rm -r`, `sudo rm`           | ✅       |
| Git nuclear         | `git reset --hard`, `git push --force` | ✅       |
| Permission bombs    | `chmod 777`, `chmod -R 777`            | ✅       |
| System writes       | `dd of=/dev/`, `mkfs`                  | ✅       |
| Process kills       | `killall -9`, `kill -9 -1`             | ✅       |
| SQL destructive     | `DELETE FROM table;`, `DROP TABLE`     | ✅       |
...
Loaded: 25 bash patterns, 8 zero-access, 13 read-only, 2 no-delete paths
